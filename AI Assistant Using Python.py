...
def Msg_Twitter():
    ...
    speak("What should I tweet ?,sir!")

    tweet = takeCommand().lower()

    Auto_Login("https://twitter.com/login", 'your email@gmail.com', 'password', '//*[@id="react-root"]/div/div/div[2]/main/div/div/div[2]/form/div/div[1]/label/div/div[2]/div/input',
...
def run():
    speak("Do you want to start this program ?")
    ...
    while True:
        ...
        if "start" in query:
            ...
            speak("Are you really want to close the program")
...
def Wtime():
    ...
    speak(f"Assistant: Sir!, the current time is{strTime}")
...
def CkInsta_Profile():
    ...
    try:
        ...
        if "yes" in condition:
            ...
            print("Assistant: reaname the image sir")
            speak("reaname the image sir")
            nam = takeCommand().lower()
            mod.download_profile(name, profile_pic_only=True)
            print('Assistant: i am done sir, profile picture is saved in our main folder')
...
def OPMusic():
    ...
    print("Assistant:Opening music file")
    speak("Opening music file")
    print(songs, end="")
...
def Location():
    ...
    try:
        ...
        speak("sorry sir!,due to some technical issue i can't find our location")
...
def CPFaceBook():
    ...
    speak("sir here is the profiles of the username that i found")


def fun():
    wishMe()
    print("Assistant: I am tokyo your personal desktop assistant.How can I help you ?")
    speak(" I am tokyo your personal desktop assistant.How can I help you ?")
    while True:
...
# ---------------------------------------------------------------------------wikipedia----------------------------------------------------------------------------------
            ...
            speak("what can i do as follows:")
...
# -----------------------------------------------------------------------------Questions------------------------------------------------------------------------------------
            ...
            speak("my name is tokyo .I am desktop assistant created by suraj and his friends as PBL Activity and I like to talk to people")

        elif 'hi' in query or 'hello' in query:
            print("hello sir, tell me how can help you")
            speak("hello sir, tell me how can help you")
            ...
            speak("I was created by Suraj. he is studying at Zeal Institue as computer enginerring.Now he is in second year of enginerring and he is very good person with a nice personality")

        elif 'you like' in query:

            if 'which fruit you like' in query:
                print("I really like mangoes")
                speak("I really like mangoes")

            elif "which place you like" in query:
                print("my favurite place is Pune. It's such a beautiful place with a nice people")
                speak("my favurite place is Pune. It's such a beautiful place with a nice people")

            else:
                print("I like to talk to diffrent peoples from diffrent places")
                speak("I like to talk to diffrent peoples from diffrent places")
...
# ------------------------------------------------------------------------------instagram----------------------------------------------------------------------------------------
            ...
            if 'instagram profile' in query:
                ...
                speak("Do you want login by your account ?")
                cmmd = takeCommand().lower()
                if 'yes' in cmmd:
                    print("Assistant: Login by your account, sir!")
                    speak("Login by your account, sir!")
                    Auto_Login("https://www.instagram.com/accounts/login/",'your email@gmail.com','password',
